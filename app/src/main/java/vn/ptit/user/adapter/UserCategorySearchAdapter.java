...
public class UserCategorySearchAdapter extends RecyclerView.Adapter<UserCategorySearchAdapter.UserCategoryViewHolder> {
    private List<Laptop> mList;
    private Context context;
    private LaptopClickListener laptopClickListener;

    public UserCategorySearchAdapter(Context context, String tabName, String name) {
        this.mList = new ArrayList<>();
        this.context = context;
        getData(tabName, name);
    ...
    public UserCategoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new UserCategorySearchAdapter.UserCategoryViewHolder(view);
    }
    ...
    public void getData(String tabName, String name) {
        ProgressDialog pDialog = new ProgressDialog(context);
        pDialog.setMessage("Loading...");
        pDialog.show();

        String url = MyDomainService.name + "/api/laptop/filter-with-name?tabName=" + tabName + "&name=" + name;
